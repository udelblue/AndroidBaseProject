...
class ListAdapterFeed extends BaseAdapter {
		private Activity activity;
		
		public ListAdapterFeed(Activity act) {
			this.activity = act;
		}
		
		public int getCount() {
			// TODO Auto-generated method stub
			return Feed.title.length;
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.txtTitle.setText(Feed.title[position]);
			holder.txtPubDate.setText(Feed.pubDate[position]);
